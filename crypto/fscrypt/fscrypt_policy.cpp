...
extern "C" void policy_to_hex(uint8_t* policy, uint8_t* hex) {
...
static bool fscrypt_policy_set(const char *directory, uint8_t *policy,
    ...
    uint8_t policy_hex[FS_KEY_DESCRIPTOR_SIZE_HEX];
...
static bool fscrypt_policy_check(const char *directory, uint8_t *policy,
    ...
    uint8_t existing_policy_hex[FS_KEY_DESCRIPTOR_SIZE_HEX];
